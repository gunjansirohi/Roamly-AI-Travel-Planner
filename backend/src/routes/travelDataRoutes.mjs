...
import { createTrip, dashboard, deleteSaved, deleteSearch, deleteTrip, duplicateTrip, getTrip, listSaved, listTrips, recordSearch, saveProviderItem, toggleTripFavorite, updateTrip } from "../controllers/travelDataController.mjs";
...
export function createTravelDataRouter() {
  ...
  router.post("/search-history", requireAuth, recordSearch); router.delete("/search-history/:id", requireAuth, deleteSearch); router.get("/dashboard", requireAuth, dashboard);
  return router;
}
